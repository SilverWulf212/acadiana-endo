...
export default function EmergencyBanner() {
  return (
    <div className="bg-navy-900 py-2.5 sm:py-2">
      <div className="container flex items-center justify-center gap-2 text-center">
        <p className="text-xs font-medium uppercase tracking-widest text-white/90">
          ...
          <a
            ...
            className="inline-block py-1 font-semibold text-gold-400 underline underline-offset-2 transition-colors duration-200 hover:text-gold-300"
          >
