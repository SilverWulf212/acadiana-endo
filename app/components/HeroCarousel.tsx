...
const slides: HeroSlide[] = [
  ...
  },
  {
    ...
    gradient:
      "from-navy-800 via-navy-900 to-navy-800",
  },
  {
      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="absolute inset-0">
            {/* Large subtle circle */}
            <div className="absolute -right-32 -top-32 h-[600px] w-[600px] rounded-full bg-gold-400/5" />
            <div className="absolute -bottom-48 -left-48 h-[500px] w-[500px] rounded-full bg-gold-400/5" />
            {/* Subtle grid pattern */}
            <div
            ...
            <div className="absolute left-0 right-0 top-0 h-px bg-gradient-to-r from-transparent via-gold-400/30 to-transparent" />
          </div>
